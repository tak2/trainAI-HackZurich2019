...
# Load the records
record_df = pd.read_csv('gdrive/My Drive/trainAI_FS/OUT/model\record.csv')
...
num_features = 512
model_path = OUT_Path+'model\model_frcnn_vgg.hdf5'
...
num_anchors = len([64, 128, 256]) * len([[1, 1], [1. / math.sqrt(2), 2. / math.sqrt(2)],[2. / math.sqrt(2), 1. / math.sqrt(2)]])
rpn_layers = rpn_layer(shared_layers, num_anchors)

classifier = classifier_layer(feature_map_input, roi_input, 4, nb_classes=4)
...
all_data, classes_count, class_mapping = get_date_XML(ANNO_file)
...
test_imgs, _, _ = get_data_XML(ANNO_file)
